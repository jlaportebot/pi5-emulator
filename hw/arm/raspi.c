...
static const struct {
    ...
    [PROCESSOR_ID_BCM2712] = {"bcm2712", 4},
};
...
/* Pi 5 board revisions (from Raspberry Pi documentation) */
#define RPI5_BOARD_REV_2G  0xc03111
#define RPI5_BOARD_REV_4G  0xc83111
#define RPI5_BOARD_REV_8G  0xd03111
#define RPI5_BOARD_REV_16G 0xd83111

static inline bool is_pi5_revision(uint32_t board_rev)
{
    /* Check for known Pi 5 board revisions */
    return board_rev == RPI5_BOARD_REV_2G ||
           board_rev == RPI5_BOARD_REV_4G ||
           board_rev == RPI5_BOARD_REV_8G ||
           board_rev == RPI5_BOARD_REV_16G;
}
...
static RaspiProcessorId board_processor_id(uint32_t board_rev)
{
    ...
    /* Pi 5 has MODEL=0xF at bits 4-7, PROCESSOR at bits 12-15 */
    if (is_pi5_revision(board_rev)) {
        return PROCESSOR_ID_BCM2712;
    }

    proc_id = FIELD_EX32(board_rev, REV_CODE, PROCESSOR);
